--[[
    ╔═══════════════════════════════════════════════════════════════════════════╗
    ║                           A U R O R A   U I                               ║
    ║                    Modern Roblox UI Framework v1.1                       ║
    ║                                                                           ║
...
function NotificationSystem:Build()
    ...
    pcall(function()
        self.Container.Parent = (gethui and gethui() or game:GetService('CoreGui'))
    end)
...
function AuroraUI:CreateWindow(props)
    ...
    if not self.MainContainer then
        ...
        pcall(function()
            self.MainContainer.Parent = (gethui and gethui() or game:GetService('CoreGui'))
        end)
